...
namespace P2FixAnAppDotNetCode.Models
{
    ...
    public class Cart : ICart
    {
        ...
        {
            //Dans la liste _lines FirstOrDefailt renvoie null si le produit n'est pas dans le panier autrement renvoie le produit.
            //var FDICLline = _lines.FirstOrDefault(line => line.Product.Id == productId);
